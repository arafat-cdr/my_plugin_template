...
################################################
###############################################
define('My_Custom_Plugin_Lang', 'eng');
################################################
...
// lang
require_once( My_Custom_Plugin_DIR_PATH.'lang/my_custom_plugin_lang.php' );

// helper
require_once( My_Custom_Plugin_DIR_PATH.'helper/helper.php' );
